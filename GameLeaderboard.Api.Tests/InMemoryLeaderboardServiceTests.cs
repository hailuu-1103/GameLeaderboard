...
public sealed class InMemoryLeaderboardServiceTests
{
    ...
    [Fact]
    public void GetTop_ReturnsPlayersOrderedByDescendingScore()
    {
        // Arrange
        var service = new InMemoryLeaderboardService();
    ...
    [Fact]
    public void GetTop_AfterAddingPlayer_RecalculatesRanking()
    {
        // Arrange
        var service = new InMemoryLeaderboardService();
        // Act
    ...
    [Fact]
    public void GetTop_WithLimit_ReturnsOnlyRequestedNumberOfPlayers()
    {
        // Arrange
        var service = new InMemoryLeaderboardService();
    ...
    [Fact]
    public void Operations_AreCaseInsensitive()
    {
        var service = new InMemoryLeaderboardService();
        Assert.True(service.LeaderboardExists("CLASSIC"));
        Assert.NotNull(service.GetPlayer("CLASSIC", "alice"));
